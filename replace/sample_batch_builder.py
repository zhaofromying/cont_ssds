...
class MultiAgentSampleBatchBuilder:
    ...
    @DeveloperAPI
    def add_cont_values(self, cont_rewards):
        for i in range(len(cont_rewards)):
            agent_id = 'agent-' + str(i)
            self.agent_builders[agent_id].buffers['cont_rewards'] = cont_rewards['agent-'+str(i)]
        # for builder in self.agent_builders.values():
        #     builder.buffers['cont_rewards'] = cont_rewards
            # builder.count += 1
